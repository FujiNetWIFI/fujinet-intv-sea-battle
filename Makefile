# Networked Intellivision Sea Battle (Mattel 1980) over FujiNet.
# 2-player lockstep netplay.
...
$(BUILD)/$(GAME)_lag0.bin: $(BUILD)/$(GAME)_patched.asm src/main_lag0.asm $(HOOK_SRCS)
...
# Sea Battle is strictly 2-player -- two fleets, no third seat to give anyone.
# The engine inherited from Bowling/Soccer is seat-generalized, but PLAYERS is
# pinned at 2 here and main_net3/4.asm do not exist.
PLAYERS  := 2
RIG_BINS := $(BUILD)/$(GAME)_net1.bin $(BUILD)/$(GAME)_net2.bin
